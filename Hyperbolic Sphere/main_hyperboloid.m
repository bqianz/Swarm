...
% calculate density
% n = 6; % n x n coarse grid
% th_coarse = linspace(0,th_up,n+1);
% phi_coarse=linspace(0,2*pi,n+1);
% [phi_mesh1,th_mesh1] = meshgrid(phi_coarse(1:end-1),th_coarse(1:end-1));
% [phi_mesh2,th_mesh2] = meshgrid(phi_coarse(2:end),th_coarse(2:end));
% Area = hyp_patch_area(th_mesh1,th_mesh2,phi_mesh1,phi_mesh2);
% 
% colour_density(th,phi);
% colorbar;
axis square;
